...
public class MusicPlayer {
    ...
    public static void Tocar() {  
        ...
        switch(a){
            case 1:
                Achuu(Musica.NomD,Musica.duracion, Musica.Artista,"files/Reproductor.txt");
                break;
            case 2:
                Achuu(Musica.NomD2,Musica.duracion2, Musica.Artista2,"files/Reproductor.txt");
                break;
            case 3:
                Achuu(Musica.NomD3,Musica.duracion3, Musica.Artista3,"files/Reproductor.txt");
                break;
            default:
